...
<html>
   <head>
      <title>Rosioly Artwork & Fine Art</title>
      <meta charset="utf-8" />
   ...
   <body>
      ...
      <header id="header" class="alt" >
         ...
         <ul class="nav navbar-nav custom-navbar">
			...
			<li><a href="index.php?page=artist_register">Artist Register</a></li>
      ...
      <nav id="menu">
         <ul class="links">
			...
			<li><a href="index.php?page=artist_login">Artist</a></li>
      ...
      <footer id="footer">
         ...
         <div class="copyright">
            <div class="footer text-center">Designed & Developed By Rosioly Art Gallery</div>
            &copy; Rosioly Art Gallery.
         </div>
      </footer>
      <!-- Scripts -->
