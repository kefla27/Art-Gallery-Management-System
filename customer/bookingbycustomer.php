...
<div class="container divform">
	...
	<form action="" method="post" name="f1">
		...
		<div class="form-group">
			<label for="a2">Artist_Id:</label>
			<input type="number" class="form-control" id="a9" name="artistid"  readonly value="<?php echo $art_result[1];?>">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="a4" name="aname" readonly  value="<?php echo $art_result[2];?>">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" id="a8" name="price" readonly value="<?php echo $art_result[4];?>">
		</div>
...
if ( isset( $_POST[ 'sub' ] ) ){
	...
	$a17=$_POST['quan'];
	$a18=($a17 * $_POST['price']);
	$sql = "INSERT INTO booking_info (cust_id, art_id,a_id, Name, bart_name, order_status, delivery_address, bart_quantity, bart_date,bart_price) VALUES ('$a11', '$a12','$a19','$a13', '$a14', '$a15','$a16', '$a17', NOW(), '$a18')"; //this is query for booking 
