   ...
   <div class="container divform">
      ...
      <form action="" method="post" name="f1">
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="a3" name="cname" readonly required value="<?php echo $art_result1[4];?>">
         </div>
         <div class="form-group">
            <label for="a4"> Art_Name:</label>
            <input type="text" class="form-control" id="a4" name="aname" readonly  value="<?php echo $art_result1[5];?>">
         </div>
         <div class="form-group">
            <label for="a5">Order_Status:</label>
            <input type="text" class="form-control" id="a5" name="os" readonly value="<?php echo $art_result1[6];?>">
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input type="number" class="form-control" id="a7" name="quan" readonly placeholder="Enter Quantity" required value="<?php echo $art_result1[8];?>">
         </div>
         <div class="form-group">
            <label for="a8">Date:</label>
            <input type="text" class="form-control" id="a8" name="date" readonly value="<?php echo $art_result1[9];?>">
         </div>
         <div class="form-group">
            <label for="a9">Price(Rs.):</label>
            <input type="text" class="form-control" id="a9" name="price" readonly value="<?php echo $art_result1[10];?>">
         </div>
         <div class="form-group">
