   ...
   <div class="content" style="overflow-x:auto">
         ...
         <div class="container divform">
            ...
            <form action="" method="post" name="f1" enctype="multipart/form-data">
			   ...
			   <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="id" name="a5" placeholder="Enter your id" required>
               </div>
               <div class="form-group">
      ...
      <?php
         ...
         echo "image success";	
         	...
         	$sql = "INSERT INTO art_info (art_name,a_id,art_category, art_price, art_discount, art_photo, art_detail) VALUES ('$a11','$a15','$a12', '$a13', '$a14', '$target_path', '$a16')"; // this is an insert query  for add product
